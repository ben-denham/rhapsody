...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__11069,opts){
var map__11070 = p__11069;
var map__11070__$1 = ((((!((map__11070 == null)))?((((map__11070.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__11070.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11070):map__11070);
var files = cljs.core.get.call(null,map__11070__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__8046__auto___11078 = arguments.length;
var i__8047__auto___11079 = (0);
while(true){
if((i__8047__auto___11079 < len__8046__auto___11078)){
args__8053__auto__.push((arguments[i__8047__auto___11079]));

var G__11080 = (i__8047__auto___11079 + (1));
i__8047__auto___11079 = G__11080;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__11074){
var vec__11075 = p__11074;
var opts = cljs.core.nth.call(null,vec__11075,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__11075,opts){
return (function (evt){
...
});})(conn,vec__11075,opts))
);

clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__11075,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__11075,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__11075,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq11072){
var G__11073 = cljs.core.first.call(null,seq11072);
var seq11072__$1 = cljs.core.next.call(null,seq11072);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__11073,seq11072__$1);
});
