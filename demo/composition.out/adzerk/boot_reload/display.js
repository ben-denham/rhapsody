...
return (function (p__10649){
var vec__10650 = p__10649;
var attr = cljs.core.nth.call(null,vec__10650,(0),null);
...
var args10653 = [];
var len__8046__auto___10656 = arguments.length;
var i__8047__auto___10657 = (0);
while(true){
if((i__8047__auto___10657 < len__8046__auto___10656)){
args10653.push((arguments[i__8047__auto___10657]));

var G__10658 = (i__8047__auto___10657 + (1));
i__8047__auto___10657 = G__10658;
continue;
} else {
}
break;
...
var len__8046__auto___10661 = arguments.length;
var i__8047__auto___10662 = (0);
while(true){
if((i__8047__auto___10662 < len__8046__auto___10661)){
args__8053__auto__.push((arguments[i__8047__auto___10662]));

var G__10663 = (i__8047__auto___10662 + (1));
i__8047__auto___10662 = G__10663;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq10660){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq10660));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__10664){
var map__10668 = p__10664;
...
var data = map__10668__$1;
var message = cljs.core.get.call(null,map__10668__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__10668__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__10668__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__10670 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__10670,goog.events.EventType.CLICK,((function (G__10670,map__10668,map__10668__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__10670,map__10668,map__10668__$1,data,message,line,file))
);

return G__10670;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__10671){
var map__10675 = p__10671;
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__10678){
var map__10682 = p__10678;
...
var messages = map__10682__$1;
var warnings = cljs.core.get.call(null,map__10682__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__10682__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__10684 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__10684,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__10684,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__10685){
var map__10688 = p__10685;
...
var messages = map__10688__$1;
var warnings = cljs.core.get.call(null,map__10688__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__10688__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__10688,map__10688__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__10688,map__10688__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__10688,map__10688__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__10688,map__10688__$1,messages,warnings,exception))
;
...
}catch (e10691){if((e10691 instanceof Error)){
var __10692 = e10691;
} else {
throw e10691;
