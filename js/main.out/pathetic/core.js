...
return cljs.core.map.call(null,cljs.core.first,cljs.core.take_while.call(null,(function (p1__2643_SHARP_){
return cljs.core._EQ_.call(null,cljs.core.first.call(null,p1__2643_SHARP_),cljs.core.second.call(null,p1__2643_SHARP_));
}),cljs.core.map.call(null,(function (p1__2644_SHARP_,p2__2645_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__2644_SHARP_,p2__2645_SHARP_],null));
}),coll1,coll2)));
});
/**
...
var G__2646 = cljs.core.first.call(null,path_pieces);
switch (G__2646) {
case "":
...
var G__2648 = cljs.core.first.call(null,path_pieces);
var G__2648__$1 = (((G__2648 instanceof cljs.core.Keyword))?G__2648.fqn:null);
switch (G__2648__$1) {
case "root":
...
var G__2650 = cljs.core.last.call(null,path_pieces);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"cwd","cwd",14056523),G__2650)){
return cljs.core.conj.call(null,path_pieces,"..");
} else {
if(cljs.core._EQ_.call(null,"..",G__2650)){
return cljs.core.conj.call(null,path_pieces,"..");
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"root","root",-448657453),G__2650)){
return path_pieces;
} else {
...
while(true){
var vec__2657 = remaining_path;
var seq__2658 = cljs.core.seq.call(null,vec__2657);
var first__2659 = cljs.core.first.call(null,seq__2658);
var seq__2658__$1 = cljs.core.next.call(null,seq__2658);
var curr = first__2659;
var remainder = seq__2658__$1;
var pred__2660 = cljs.core._EQ_;
var expr__2661 = curr;
if(cljs.core.truth_(pred__2660.call(null,null,expr__2661))){
return result;
} else {
if(cljs.core.truth_(pred__2660.call(null,"",expr__2661))){
var G__2663 = result;
var G__2664 = remainder;
result = G__2663;
remaining_path = G__2664;
continue;
} else {
if(cljs.core.truth_(pred__2660.call(null,".",expr__2661))){
var G__2665 = result;
var G__2666 = remainder;
result = G__2665;
remaining_path = G__2666;
continue;
} else {
if(cljs.core.truth_(pred__2660.call(null,"..",expr__2661))){
var G__2667 = pathetic.core.up_dir.call(null,result);
var G__2668 = remainder;
result = G__2667;
remaining_path = G__2668;
continue;
} else {
var G__2669 = cljs.core.conj.call(null,result,curr);
var G__2670 = remainder;
result = G__2669;
remaining_path = G__2670;
continue;
}
}
}
...
var pred__2674 = cljs.core._EQ_;
var expr__2675 = curr;
if(cljs.core.truth_(pred__2674.call(null,null,expr__2675))){
return suffix;
} else {
if(cljs.core.truth_(pred__2674.call(null,"",expr__2675))){
var G__2677 = suffix;
var G__2678 = cljs.core.rest.call(null,remainder);
suffix = G__2677;
remainder = G__2678;
continue;
} else {
if(cljs.core.truth_(pred__2674.call(null,".",expr__2675))){
var G__2679 = suffix;
var G__2680 = cljs.core.rest.call(null,remainder);
suffix = G__2679;
remainder = G__2680;
continue;
} else {
if(cljs.core.truth_(pred__2674.call(null,"..",expr__2675))){
var G__2681 = cljs.core.conj.call(null,suffix,"..");
var G__2682 = cljs.core.rest.call(null,remainder);
suffix = G__2681;
remainder = G__2682;
continue;
} else {
var G__2683 = cljs.core.conj.call(null,suffix,curr);
var G__2684 = cljs.core.rest.call(null,remainder);
suffix = G__2683;
remainder = G__2684;
continue;
}
...
var vec__2685 = pathetic.core.split_url_on_path.call(null,url_or_string);
var pre_path = cljs.core.nth.call(null,vec__2685,(0),null);
var path = cljs.core.nth.call(null,vec__2685,(1),null);
var post_path = cljs.core.nth.call(null,vec__2685,(2),null);
...
var vec__2688 = pathetic.core.split_url_on_path.call(null,url_or_string);
var pre_path = cljs.core.nth.call(null,vec__2688,(0),null);
var path = cljs.core.nth.call(null,vec__2688,(1),null);
var post_path = cljs.core.nth.call(null,vec__2688,(2),null);
