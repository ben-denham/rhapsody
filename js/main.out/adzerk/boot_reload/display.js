...
return (function (p__10380){
var vec__10381 = p__10380;
var attr = cljs.core.nth.call(null,vec__10381,(0),null);
var v = cljs.core.nth.call(null,vec__10381,(1),null);
...
var args10384 = [];
var len__8046__auto___10387 = arguments.length;
var i__8047__auto___10388 = (0);
while(true){
if((i__8047__auto___10388 < len__8046__auto___10387)){
args10384.push((arguments[i__8047__auto___10388]));

var G__10389 = (i__8047__auto___10388 + (1));
i__8047__auto___10388 = G__10389;
continue;
} else {
}
break;
...
var len__8046__auto___10392 = arguments.length;
var i__8047__auto___10393 = (0);
while(true){
if((i__8047__auto___10393 < len__8046__auto___10392)){
args__8053__auto__.push((arguments[i__8047__auto___10393]));

var G__10394 = (i__8047__auto___10393 + (1));
i__8047__auto___10393 = G__10394;
continue;
} else {
}
break;
...
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(argseq__8054__auto__);
});
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq10391){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq10391));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__10395){
var map__10399 = p__10395;
...
var data = map__10399__$1;
var message = cljs.core.get.call(null,map__10399__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__10399__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__10399__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__10401 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__10401,goog.events.EventType.CLICK,((function (G__10401,map__10399,map__10399__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__10401,map__10399,map__10399__$1,data,message,line,file))
);

return G__10401;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__10402){
var map__10406 = p__10402;
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__10409){
var map__10413 = p__10409;
...
var messages = map__10413__$1;
var warnings = cljs.core.get.call(null,map__10413__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__10413__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__10415 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__10415,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__10415,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__10416){
var map__10419 = p__10416;
var map__10419__$1 = ((((!((map__10419 == null)))?((((map__10419.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10419.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10419):map__10419);
var messages = map__10419__$1;
var warnings = cljs.core.get.call(null,map__10419__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__10419__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__10419,map__10419__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__10419,map__10419__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__10419,map__10419__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__10419,map__10419__$1,messages,warnings,exception))
;
