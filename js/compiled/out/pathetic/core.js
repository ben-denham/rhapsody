...
return cljs.core.map.call(null,cljs.core.first,cljs.core.take_while.call(null,(function (p1__23139_SHARP_){
return cljs.core._EQ_.call(null,cljs.core.first.call(null,p1__23139_SHARP_),cljs.core.second.call(null,p1__23139_SHARP_));
}),cljs.core.map.call(null,(function (p1__23140_SHARP_,p2__23141_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__23140_SHARP_,p2__23141_SHARP_],null));
}),coll1,coll2)));
});
/**
...
var G__23143 = cljs.core.first.call(null,path_pieces);
switch (G__23143) {
case "":
...
var G__23146 = (((cljs.core.first.call(null,path_pieces) instanceof cljs.core.Keyword))?cljs.core.first.call(null,path_pieces).fqn:null);
switch (G__23146) {
case "root":
...
var G__23149 = cljs.core.last.call(null,path_pieces);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"cwd","cwd",14056523),G__23149)){
return cljs.core.conj.call(null,path_pieces,"..");
} else {
if(cljs.core._EQ_.call(null,"..",G__23149)){
return cljs.core.conj.call(null,path_pieces,"..");
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"root","root",-448657453),G__23149)){
return path_pieces;
} else {
...
while(true){
var vec__23156 = remaining_path;
var seq__23157 = cljs.core.seq.call(null,vec__23156);
var first__23158 = cljs.core.first.call(null,seq__23157);
var seq__23157__$1 = cljs.core.next.call(null,seq__23157);
var curr = first__23158;
var remainder = seq__23157__$1;
var pred__23159 = cljs.core._EQ_;
var expr__23160 = curr;
if(cljs.core.truth_(pred__23159.call(null,null,expr__23160))){
return result;
} else {
if(cljs.core.truth_(pred__23159.call(null,"",expr__23160))){
var G__23162 = result;
var G__23163 = remainder;
result = G__23162;
remaining_path = G__23163;
continue;
} else {
if(cljs.core.truth_(pred__23159.call(null,".",expr__23160))){
var G__23164 = result;
var G__23165 = remainder;
result = G__23164;
remaining_path = G__23165;
continue;
} else {
if(cljs.core.truth_(pred__23159.call(null,"..",expr__23160))){
var G__23166 = pathetic.core.up_dir.call(null,result);
var G__23167 = remainder;
result = G__23166;
remaining_path = G__23167;
continue;
} else {
var G__23168 = cljs.core.conj.call(null,result,curr);
var G__23169 = remainder;
result = G__23168;
remaining_path = G__23169;
continue;
}
}
}
...
var pred__23173 = cljs.core._EQ_;
var expr__23174 = curr;
if(cljs.core.truth_(pred__23173.call(null,null,expr__23174))){
return suffix;
} else {
if(cljs.core.truth_(pred__23173.call(null,"",expr__23174))){
var G__23176 = suffix;
var G__23177 = cljs.core.rest.call(null,remainder);
suffix = G__23176;
remainder = G__23177;
continue;
} else {
if(cljs.core.truth_(pred__23173.call(null,".",expr__23174))){
var G__23178 = suffix;
var G__23179 = cljs.core.rest.call(null,remainder);
suffix = G__23178;
remainder = G__23179;
continue;
} else {
if(cljs.core.truth_(pred__23173.call(null,"..",expr__23174))){
var G__23180 = cljs.core.conj.call(null,suffix,"..");
var G__23181 = cljs.core.rest.call(null,remainder);
suffix = G__23180;
remainder = G__23181;
continue;
} else {
var G__23182 = cljs.core.conj.call(null,suffix,curr);
var G__23183 = cljs.core.rest.call(null,remainder);
suffix = G__23182;
remainder = G__23183;
continue;
}
...
var vec__23187 = pathetic.core.split_url_on_path.call(null,url_or_string);
var pre_path = cljs.core.nth.call(null,vec__23187,(0),null);
var path = cljs.core.nth.call(null,vec__23187,(1),null);
var post_path = cljs.core.nth.call(null,vec__23187,(2),null);
...
var vec__23193 = pathetic.core.split_url_on_path.call(null,url_or_string);
var pre_path = cljs.core.nth.call(null,vec__23193,(0),null);
var path = cljs.core.nth.call(null,vec__23193,(1),null);
var post_path = cljs.core.nth.call(null,vec__23193,(2),null);
...
//# sourceMappingURL=core.js.map?rel=1482038774879