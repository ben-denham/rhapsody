...
leipzig.scale.floor = (function leipzig$scale$floor(p1__22278_SHARP_){
return Math.floor(p1__22278_SHARP_);
});
leipzig.scale.ceil = (function leipzig$scale$ceil(p1__22280_SHARP_){
return Math.ceil(p1__22280_SHARP_);
});
if(typeof leipzig.scale.scale_of !== 'undefined'){
} else {
leipzig.scale.scale_of = (function (){var method_table__21458__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"leipzig.scale","scale-of"),((function (method_table__21458__auto__,prefer_table__21459__auto__,method_cache__21460__auto__,cached_hierarchy__21461__auto__,hierarchy__21462__auto__){
...
return cljs.core.comp.call(null,(function (p1__22281_SHARP_){
return (p1__22281_SHARP_ - scale.call(null,n));
...
//# sourceMappingURL=scale.js.map?rel=1482038773499